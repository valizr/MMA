...
class Zend_Form_Element_Textarea extends Zend_Form_Element_Xhtml
{
	...
	{
		$this->tinymce .= '$("#'.$this->_name.'").livequery(function(){
									$(this).tinymce({
										script_url : \''.WEBROOT.'/js/tiny_mce/tiny_mce.js\',
										theme_advanced_buttons1 : "bold,italic,underline,strikethrough,|,justifyleft,justifycenter,justifyright,justifyfull,|,styleselect,formatselect,fontselect,fontsizeselect |,forecolor,backcolor",
										theme_advanced_buttons2 : "cut,copy,paste|,search,replace,|,bullist,numlist,|,outdent,indent,blockquote,|,undo,redo,|,link,unlink,anchor,cleanup,help,code"
									});	
								});';
	}
