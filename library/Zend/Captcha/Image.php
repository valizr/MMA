...
class Zend_Captcha_Image extends Zend_Captcha_Word
{
   ...
   /**
    ...
    protected function _generateImage($id, $word)
    {
        ...
        $bg_color   = imagecolorallocatealpha($img, 0xff, 0xff, 0xff, 0);		
       ...
       // generate noise
        ...
        $img2     = imagecreatetruecolor($w, $h);
         $bg_color   = imagecolorallocatealpha($img, 0xf3, 0xfa, 0xf9, 0);		
        ...
        // generate noise
        for ($i=0; $i<$this->_dotNoiseLevel; $i++) {
            imagefilledellips($img2, mt_rand(0,$w), mt_rand(0,$h), 2, 2, $text_color);
        }
        for ($i=0; $i<$this->_lineNoiseLevel; $i++) {
