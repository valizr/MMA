<?php
class Default_Form_MessagesSearch extends Zend_Form
{
	function init()
	{
		$this->setMethod('post');
		...
		$searchTxt->setAttribs(array('class'=>'rightAdd validate[required]','placeholder'=>'Search text','style'=>'width:200px;'));
