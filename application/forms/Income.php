<?php
class Default_Form_Income extends Zend_Form 
{
	function init()
	{
		...
		$name->setAttribs(array('class'=>'text validate[required] rightAdd','placeholder'=>Zend_Registry::get('translate')->_('admin_income_description')));
		...
		$submit->setValue(Zend_Registry::get('translate')->_('admin_add_income'));
	...
	function edit(Default_Model_Expenses $model)
	{
		...
		$this->submit->setValue(Zend_Registry::get('translate')->_('admin_edit_income'));
	}
