<?php
class Default_Form_Expenses extends Zend_Form 
{
	function init()
	{
		...
		$name->setAttribs(array('class'=>'text validate[required] rightAdd','placeholder'=>Zend_Registry::get('translate')->_('admin_expense_description')));
		...
		$date->setLabel(Zend_Registry::get('translate')->_('admin_select_day'));
		...
		$submit->setValue(Zend_Registry::get('translate')->_('admin_add_expense'));
