<?php
class RecurrentExpensesController extends Zend_Controller_Action{
	...
	public function deleteAction() {
		...
		if ($model->find($id)) {
			if ($expenseId = $model->delete()) {
					...
					$this->_flashMessenger->addMessage("<div class='success  canhide'><p>Recurrent expense was deleted successfully!<a href='javascript:;'></a></p></div>");
				} else {
					$this->_flashMessenger->addMessage("<div class='failure canhide'><p>Recurrent expense was not deleted!<a href='javascript:;'></a></p></div>");
				}
			$this->_redirect('recurrent-expenses');
		}
	}
}